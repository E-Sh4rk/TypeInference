...
\begin{document}
    ...
    \begin{mathpar}
      ...
      \Infer[App]
      {}
      {(\underbrace{(\lambda^tx.e) v}_E, \varnothing) \leadsto (\underbrace{e\subst x v}_{E'}, \subst {E} {E'})}
      {}\\
      \Infer[TestCtx]
      {(e,\varnothing) \leadsto (e',\rho)}
      {(\underbrace{\ite e t {e_1} {e_2}}_E, \varnothing) \leadsto (\underbrace{\ite {e'} t {e_1\rho} {e_2\rho}}_{E'}, \subst {E} {E'})}
      {}\\
      \Infer[Ite]
      {i \in \{1,2\}\hspace{1cm} (i=1 \Leftrightarrow v \in t)}
      {(\underbrace{\ite v t {e_1} {e_2}}_E,\varnothing) \leadsto (\underbrace{e_i}_{E'},\subst {E} {E'})}
      {}\\
    \end{mathpar}
