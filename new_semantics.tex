...
\begin{document}
    ...
    \begin{align*}
      ...
      &\Gamma^p_{\cons e {es},\cons t {ts}} (\Gamma) = \Gamma^p_{es,ts}(\Gamma,\Gamma^p_{\Gamma,e,t})
    \end{align*}
    ...
    \begin{mathpar}
      ...
      \end{definition}
        ...
        So let's suppose $e\not\in\dom\Gamma$ (in particular, we know that $e$ is not a variable and that the last rule applied to type $\Gamma \vdash e:t$ can't be $\Rule{Occ}$).
        ...
        \begin{description}
          ...
          \item[$\ite {e_0} {t_{if}} {e_1} {e_2}$] TODO: Should use well-formedness here.
