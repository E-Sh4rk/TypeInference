...
\begin{document}
    ...
    \begin{array}{lcl}
      ...
      \Gp p {\Gamma,e,t} (\varpi) & = & \typep p {\Gamma,e,t} \varpi \land \tyof {\occ e \varpi} \Gamma
    ...
    \begin{mathpar}
      ...
      \Infer[If]
            {\Gamma\vdash e:t_0\\
              \left\{
                \makebox{$\begin{array}{ll}
                \Gamma, \Gamma^+_{\Gamma,e,t}\vdash e_1 : t_1 & \text{ if } t_0 \land t \neq \varnothing\\
                t_1 = \Empty & \text{ otherwise}
              \end{array}$}\right.\\
              \left\{
                \makebox{$\begin{array}{ll}
                \Gamma, \Gamma^-_{\Gamma,e,t}\vdash e_2 : t_2 & \text{ if } t_0 \land \neg t \neq \varnothing\\
      ...
      \end{definition}
        ...
        \begin{description}
          ...
          \begin{itemize}
            ...
            \begin{align*}
              \Gamma^+_{\Gamma\rho,e_0\rho,t_{\text{if}}}(e_s\rho) &= \bigwedge_{\{\varpi\alt \occ {e_0\rho} \varpi=e_s\rho\}} \Gp + {\Gamma\rho,e_0\rho,t_{\text{if}}} (\varpi)\\
