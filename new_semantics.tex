...
\begin{document}
    ...
    TODO: Add a certain condition on the type of lambda abstractions

    TODO: Close by equivalence with a certain definition
    ...
    \begin{mathpar}
      ...
      TODO: Add constraint on values (should be 'equivalent' to the taw type of the value, with a certain definition)
      \end{definition}
