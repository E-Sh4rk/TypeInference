    ...
    \begin{mathpar}
      ...
      \end{definition}
        ...
        \begin{description}
          ...
          %Using the induction hypothesis, we know that every $\Gp {} {}$ and $\tyof {} {}$ used in the computation of $\Gaux {\cons {(e_0,t_{if},p)} \tenv} {\Gamma'}$
          %are smaller than those used in the computation of $\Gaux {\cons {(e_0,t_{if},p)} \tenv} \Gamma$.
