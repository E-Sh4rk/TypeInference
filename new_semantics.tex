...
\begin{document}
    ...
    \begin{mathpar}
      ...
      \Infer[App]
      {}
      {(E=(\lambda^tx.e) v, \varnothing) \leadsto (E'=e\subst x v, \subst {E} {E'})}
      {}\\
      \Infer[TestCtx]
      {(e,\varnothing) \leadsto (e',\rho)}
      {(E=\ite e t {e_1} {e_2}, \varnothing) \leadsto (E'=\ite {e'} t {e_1\rho} {e_2\rho}, \subst {E} {E'})}
      {}\\
      \Infer[Ite]
      {i \in \{1,2\}\hspace{1cm} (i=1 \Leftrightarrow v \in t)}
      {(E=\ite v t {e_1} {e_2},\varnothing) \leadsto (E'=e_i,\subst {E} {E'})}
      {}\\
    \end{mathpar}
    ...
    \begin{mathpar}
      ...
      \begin{definition}[Environment inclusion]
        ...
        \begin{align*}
          ...
          &\forall e' \in \dom {\Gamma'}.\ \Gamma \vdash e' : t \Rightarrow \Gamma(e') \leq t
        \end{align*}
      ...
      \end{definition}
        ...
        \begin{lemma}[Substitution]
          Let $\Gamma$ an environment, $e$, $e_a$ and $e_b$ some expressions, $t$, $t_a$ and $t_b$ somes types.
          If $\Gamma \vdash e:t$ and $\Gamma \vdash e_a : t_a$ and $\Gamma \vdash e_b:t_b$ with $t_b \leq t_a$, then:
          \begin{align*}
        ...
        \begin{description}
          ...
          We can build a derivation for $\Gamma' \vdash e:t'$ (with $t'\leq t$) with $\Rule {If}$ as last rule.
        ...
        \begin{description}
          ...
          \begin{itemize}
            ...
            \item Let $\Gamma_1 = \Gamma,\Gamma^+_{\Gamma,e_0,t_{\text{if}}}$. Let $\Gamma_1'=\Gamma_1,(e_a:\tyof {e_a} {\Gamma_1}), (e_b:\tyof {e_a} {\Gamma_1}\land\tyof {e_b} {\Gamma_1}\land\bigwedge_{\{e'\in \dom {\Gamma_1}\alt e'\rho=e_b\}} \Gamma_1(e'))$.
