...
\begin{document}
  ...
  \end{definition}
    ...
    \begin{theorem}[Subject reduction]
      Let $\Gamma$ an environment that is ordinary, $e$ and $e'$ two expressions and $t$ a type.
    ...
    \begin{description}
      ...
      %Thus, we can derive $\Gamma,(x:s_i) \vdash e_x : t_i$ for any $i\in I$.
      %
      ...
      %(the hypotheses are easily verified since $\Gamma$ is ordinary).
      ...
      \begin{description}
        ...
        Let's show that $\Gamma, \Gamma^+_{\Gamma,v_0,t_{if}}$ is equivalent to $\Gamma$.
