...
\begin{document}
  ...
  \end{definition}
    ...
    \begin{description}
      ...
      In both case, we can derive $\Gamma,(x:s_i) \vdash e_x : t_i$ for any $i\in I$ (the fact that $\Gamma$ is trivial is useful in the case of the rule $\Rule{Occ}$).
      ...
      We can apply the corollary of the substitution lemma to get $\Gamma \vdash e_x\subst x {v_2} : t''$ with $t'' \leq t'$.
