...
\begin{document}
  ...
  \end{definition}
    ...
    \begin{description}
      ...
      \begin{itemize}
        \item By induction, we directly get $\Gamma\rho\vdash e_0\rho:t_0$.
        ...
        Thus, we get by induction: $\Gamma_1'\rho\vdash e_1\rho:t_1'$ with $t_1' \leq t_1$.\\
        ...
        We deduce, by using the inclusion lemma, $\Gamma\rho, \Gamma^+_{\Gamma\rho,e_0\rho,t_{\text{if}}} \vdash e_1\rho:t_1''$ with $t_1'' \leq t_1' \leq t_1$.
    ...
    As $t_{e'} \leq t_x$, we have $\Gamma, (e':t_{e'}) \leq \Gamma, (e':t_x)$.
    Thus, by using the inclusion lemma, we have $\Gamma, (e':t_{e'}) \vdash e\rho:t''$ with $t'' \leq t' \leq t$.

    Finally, it is clear that $\Gamma, (e':t_{e'}) \equiv \Gamma$ (because $\Gamma \vdash e':t_{e'}$),
    so we can conclude $\Gamma \vdash e\rho:t''$ by using the equivalence lemma.
