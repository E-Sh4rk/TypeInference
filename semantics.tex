...
\begin{document}
  ...
  \maketitle
    ...
    \[
      \begin{array}{lrcl}
      \textbf{Expressions} & e & ::= & c\alt x \alt \lambda^{\bigwedge \arrow {\hat t} {\hat t}}x.e \alt e e \alt \ite k {\hat t} e e\\
      \textbf{Conditions} & k & ::= & c\alt x \alt \lambda^{\bigwedge \arrow {\hat t} {\hat t}}x.e \alt k k\\
