...
\begin{document}
  ...
  \end{definition}
    ...
    \begin{lemma}[Test reduction]
      ...
      then $\forall p.\ \Gamma^p_{\Gamma,e',t'} \leq \Gamma^p_{\Gamma,e,t}$ with $t'$ a type such that $\Gamma \vdash e':t'$ and $t'\leq t$.
    \end{lemma}
    ...
    \begin{description}
      ...
      \item[$\ite {v_0} {t_{if}} {e_1} {e_2}$] This case is trivial as $\Gamma^p_{\Gamma,e,t} = (e, t\land t_{if})$.
      \item[$\ite {e_0} {t_{if}} {e_1} {e_2}$] This case is trivial as $\Gamma^p_{\Gamma,e,t} = (e, t\land t_{if})$.
    \end{description}
    ...
    \begin{description}
      ...
      $\Gamma^-_{\Gamma,e_0',t_{if}} \leq \Gamma^+_{\Gamma,e_0,t_{if}}$ with $t_0'$ such that $\Gamma \vdash e_0':t_0'$ and $t_0' \leq t_0$.
