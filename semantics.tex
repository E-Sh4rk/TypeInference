...
\begin{document}
  ...
  \end{definition}
    ...
    \begin{lemma}[Substitution lemma]
      Let $\Gamma$ an environment, $x$ a variable, $e$ and $e'$ two expressions, $t$ and $t_x$ two types.
    ...
    \begin{corollary}[Substitution lemma 2]
      Let $\Gamma$ an environment, $x$ a variable that does not appear in $\dom \Gamma$, $e$ and $e'$ two expressions, $t$ a type and $t_x$ a type that is not $\Empty$.\\
    ...
    \begin{description}
      ...
      Let's focus on $\Gamma_1=\Gamma,\Gamma^+_{\Gamma,e_0,t_{\text{if}}}$. TODO\\
