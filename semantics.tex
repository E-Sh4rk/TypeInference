  ...
  \end{definition}
    ...
    \begin{description}
      ...
      \begin{itemize}
        ...
        We have $\Gamma_1' \leq \Gamma_1$.
        As $\Gamma_1 \vdash e_1:t_1$, we have by using the monotonicity lemma $\Gamma_1' \vdash e_1:t_1'$ with $t_1'\leq t_1$.
        Thus, we get by induction hypothesis (the conditions can easily be verified) $\Gamma_1'\rho\vdash e_1\rho:t_1'$ with $t_1' \leq t_1$.
        ...
        So, we have $\Gamma\rho, \Gamma^+_{\Gamma\rho,e_0\rho,t_{\text{if}}} \leq \Gamma_1\rho = \Gamma_1'\rho$.
