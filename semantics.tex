  ...
  \maketitle
    ...
    \begin{mathpar}
      ...
      \begin{definition}[Well formed environment]
        ...
        \begin{align*}
          &\forall e \in \dom \Gamma \text{ not a variable. } \exists \ts \text{ not empty}.\ \Gamma\setminus\{e\} \vdash e : \ts \text{ and } \tsint \ts \subseteq \tsint {\Gamma(e)}
        \end{align*}
      \end{definition}
      ...
      \begin{definition}[Environment inclusion]
        ...
        \begin{align*}
          &\forall e \in \dom \Gamma.\ \Gamma' \vdash e : \ts \text{ with } \tsint {\Gamma(e)} \subseteq \tsint \ts
        \end{align*}
      \end{definition}
      ...
      \end{definition}
        ...
        \end{corollary}
        Proof: corollary of the monotonicity lemma, by noticing that $\Gamma \leq \Gamma' \text{ and } \Gamma' \leq \Gamma \Leftrightarrow \Gamma \equiv \Gamma'$.
