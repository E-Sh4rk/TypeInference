...
\begin{document}
  ...
  \maketitle
    ...
    \[
      ...
      \textbf{Annoted expressions} & a & ::= & c\alt x \alt \lambda^{\bigwedge \arrow t t}x.e \alt a a \alt \aite e t e e t\\
    ...
    \begin{mathpar}
      ...
      \begin{definition}[Environment substitution]
        ...
        \begin{align*}
          ...
          &\forall e \in \dom {\Gamma\rho}, (\Gamma\rho)(e) = \tsand_{e' \in \dom \Gamma \text{ s.t. } e'\rho\equiv e}\Gamma(e')
        \end{align*}
      \end{definition}
