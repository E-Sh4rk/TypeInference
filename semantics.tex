...
\begin{document}
  ...
  \maketitle
    ...
    TODO: in types, fixpoint and semantics: define and use aleq operator between two type schemes
    ...
    \[
      \begin{array}{lrcl}
      \textbf{Expressions} & e & ::= & c\alt x \alt \lambda^{\bigwedge \arrow t t}x.e \alt e e \alt \ite k t e e\\
    ...
    \begin{mathpar}
      ...
      \begin{definition}[Well formed environments]
        ...
        \begin{align*}
          ...
          &\forall e \in \dom \Gamma \text{ not a variable. } \exists \ts \text{ not empty}.\ \tenv,\Gamma\setminus\{e\} \vdash e : \ts \text{ and } \tsint \ts \subseteq \tsint {\Gamma(e)}
        \end{align*}
      \end{definition}
      ...
      \begin{definition}[Environment inclusion]
        ...
        are well-formed. We says that $\Gamma' \leq_{\tenv} \Gamma$ iff:
        \begin{align*}
          &\forall e \in \dom \Gamma.\ \tenv,\Gamma' \vdash e : \ts \text{ with } \tsint {\Gamma(e)} \subseteq \tsint \ts
        \end{align*}
      \end{definition}
      ...
      \begin{definition}[Environment substitution]
        ...
        \begin{align*}
          ...
          &\forall e \in \dom {\Gamma\rho}, (\Gamma\rho)(e) = \tsand_{e' \in \dom \Gamma \text{ s.t. } e'\rho=e}\Gamma(e')
        \end{align*}
      \end{definition}
      ...
      \end{definition}
        ...
        \begin{lemma}[Well-formedness preservation]
          ...
          Then $(\tenv,\Gamma\rho)$ is well-formed.
        \end{lemma}
        ...
        \begin{lemma}[Monotonicity]
          ...
          Then:\\
          \begin{align*}
            &\tenv, \Gamma' \vdash e:\ts' \text{ with } \tsint \ts \subseteq \tsint {\ts'}
          \end{align*}
        \end{lemma}
        ...
        \begin{corollary}[Strengthening]
          ...
          $\tenv, (\Gamma, (x:\ts_1^x\tsand \ts_2^x)) \vdash e:\ts$ with $\tsint {t_1\tsand t_2} \subseteq \tsint \ts$.
        \end{corollary}

        TODO: update (tenv, etc)
