    ...
    \section{Theorems}
        ...
        \begin{description}
          ...
          \begin{itemize}
            ...
            \item $e_0$ is not a value. In this case, we must have $e_0\xleadsto{\rho} e_0'$ and $e'\equiv \ite {e_0'} {t_{if}} {e_1\rho} {e_2\rho}$.
            Moreover, by construction of the semantics, we know that $e_0'=e_0\rho$. TODO (not yet true)
          \end{itemize}
        \end{description}
