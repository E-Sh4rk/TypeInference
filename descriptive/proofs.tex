    ...
    \section{Theorems}
        ...
        \begin{description}
          ...
          \begin{itemize}
            ...
            we can easily transform it by appending a rule \Rule{PIntersect} with a \Rule{PTypeof} as premise.
            ...
            $\Gamma,(\occ e \varpi:t_1') \vdash e' : t_2$ just by adding some rules \Rule{Subs} just after \Rule{Occ} when necessary.
            It does not change the structure of the derivation (except for the added \Rule{Subs}, but it has no impact),
