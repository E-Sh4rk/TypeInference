  ...
  TODO: add rules for pairs.
    ...
    \section{Theorems}
        ...
        \begin{description}
          ...
          we can derive $\Gamma \vdash \occ e {\varpi.x} : \Empty$ by using the rule \Rule{Intersect} and the rule \Rule{Abs+}, \Rule{Abs-} or \Rule{Const}.
          ...
          Now, by starting from $\pvdash \Gamma e t \varpi:t_2$ and using the rules \Rule{PIntersect} and \Rule{PTypeof}, we can derive
        ...
        \Rule{PTypeof}, \Rule{PIntersect}, \Rule{PSubs} and \Rule{PEps}.
        Moreover, as $v \in \valsemantic{t}$, the rules \Rule{PEps} can be replaced by \Rule{PTypeof}.
