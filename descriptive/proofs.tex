  ...
  \maketitle
    ...
    \section{Theorems}
        ...
        \begin{lemma}[Monotonicity]
          ...
          Let $e$ an expression and $t$ a type such that $\Gamma \vdash e:t$.
          Then, we have $\Gamma' \vdash e:t$.
        \end{lemma}
        ...
        \begin{lemma}[Substitution] TODO: Add constraints...\\
          ...
          If $e \in \dom \Gamma$, $\Gamma \vdash e:t$ and $\Gamma \vdash e_a : t'$ and $\Gamma\subst {e_a} {e_b} \vdash e_b:t'$.
          Then:
          \begin{align*}
