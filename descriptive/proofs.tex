  ...
  \maketitle
    ...
    \section{Theorems}
        ...
        \begin{lemma}[Value typing]
          TODO: Fix the lemma. It is not true because a value could be typed to $\Empty$.
          ...
          \begin{align*}
            ...
            \forall \varpi \text{ s.t. }\occ e \varpi = v, \forall t'.\ &\Gamma \vdash v:t' \Leftrightarrow \pvdash \Gamma p e t \varpi:t'
          \end{align*}
        ...
        \begin{description}
          ...
          \begin{itemize}
            ...
            According to the value typing lemma, we can deduce a derivarion for $\Gamma \vdash e_1: t$ (because $e_0$ is a value).
