    ...
    \section{Theorems}
        ...
        \begin{description}
          ...
          \begin{itemize}
            ...
            Moreover, as $\Gamma^p \neq \bot$, we have $\forall v\in\dom{\Gamma^p}.\ \Gamma'\vdash v : \Gamma^p(v)$.
            TODO: clarify this point and every point that states that values can only be strictly refined by Empty (actually they could take any typein the env).
