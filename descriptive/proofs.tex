...
\begin{document}
  ...
  \maketitle
    ...
    \section{Theorems}
        ...
        \begin{lemma}[Value strengthening]
        ...
        By using the value strengthening lemma, we can assume without loss of generality that this derivation
        never uses the rule \Rule{Path} with $\occ e \varpi$ refering to a value.
        ...
        \begin{description}
          ...
          \begin{itemize}
            ...
            which guarantees $\Gamma,(x:s_i) \vdash e_x:t_i$. Let's note $\Gamma'=\Gamma,(x:s_i)$.
          ...
          \begin{itemize}
            ...
            As $e_0$ is a value, the \Rule{Path} rules that end the derivation must satisfy $\occ {e_1} \varpi \simeq e_0$ (= value).
            According to the value strengthening lemma, we can thus deduce a derivarion for $\Gamma \vdash e_1: t$. TODO: can't directly apply the lemma.
