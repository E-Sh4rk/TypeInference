...
\begin{document}
    ...
    We can deduce that there is finitely many possible environements that can be produced by the successive $\Gaa p {\vec {i}}$,
    and so we always reach a fixpoint in a finite number of iterations.
\end{document}