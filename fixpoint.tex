...
\begin{document}
    ...
    \newcommand{\structs}[2]{\texttt{Structs}_{#1}(#2)}
    ...
    \[
      \left\{
        \begin{array}{lcl}
          ...
          \structof{\struct}{(e_1,e_2)} & = & \bigcup_{s_1\in\structof{\struct}{e_1}}\bigcup_{s_2\in\structof{\struct}{e_2}}  \{ (s_1,s_2) \} \\
    ...
    \[
      \left\{
        \begin{array}{lcl}
          ...
          TODO \pathstr{\struct,e}{\varpi.f} & = & \bigcup_{s_1\in\pathstr{\struct,e}{\varpi}} \bigcup_{s_2\in\structof{\struct}{\occ e {\varpi.s}}} \{\pair {s_1} {s_2}\} \\
          TODO \pathstr{\struct,e}{\varpi.s} & = & \bigcup_{s_1\in\structof{\struct}{\occ e {\varpi.f}}} \bigcup_{s_2\in\pathstr{\struct,e}{\varpi}} \{\pair {s_1} {s_2}\}
        \end{array}  
      \right.
    \]
    ...
    \begin{description}
      \item[$\varpi.1$] TODO %We just have to notice that plinths are stable by $\worra {} {}$
