...
\begin{document}
  ...
  \qquad
  \Infer[Inter]
      { \tenv, \Gamma \vdash e:t_1\\\tenv, \Gamma \vdash e:t_2 }
      { \tenv, \Gamma \vdash e: t_1 \wedge t_2 }
      { }
      \qquad
      \Infer[Subs]
      { \tenv, \Gamma \vdash e:t\\t\leq t' }
      { \tenv, \Gamma \vdash e: t' }
      { }
      \\
      \Infer[Const]
  ...
  \Infer[App]
      {
        \tenv, \Gamma \vdash e_1: \arrow {t_1}{t_2}\quad
        \tenv, \Gamma \vdash e_2: t_1
      }
      { \tenv, \Gamma \vdash {e_1}{e_2}: t_2 }
      { }
          \\
          \Infer[Abs+]
            {{\scriptstyle\forall i\in I}\quad\tenv, \Gamma,x:s_i\vdash e:t_i}
            {
          ...
          \\
          \Infer[Abs-]
          {\tenv, \Gamma \vdash \lambda^{\wedge_{i\in I}\arrow {s_i} {t_i}}x.e:t}
          {\tenv, \Gamma \vdash\lambda^{\wedge_{i\in I}\arrow {s_i} {t_i}}x.e:\neg(t_1\to t_2)  }
...
%            { }
        ...
        \tenv_1 = \cons {(e,t)} \tenv\\
        %t_0\not\leq \neg t \Rightarrow
        \Gamma \evdashCF {\tenv_1} \Gamma_1 \\ \tenv_1, \Gamma_1 \vdash e_1:t'\\
        %t_0\not\leq t \Rightarrow
        \tenv_2 = \cons {(e,\neg t)} \tenv\\
        \Gamma \evdashCF {\tenv_2} \Gamma_2 \\ \tenv_2, \Gamma_2 \vdash e_2:t'}
        {\tenv, \Gamma\vdash \tcase {e} t {e_1}{e_2}: t'}
        { }
      \\
      \Infer[Efq]
      { }
      { \tenv, \Gamma, (e:\Empty) \vdash e': t }
      { }
      \qquad
      \Infer[Proj]
  {\tenv, \Gamma \vdash e:\pair{t_1}{t_2}}
  {\tenv, \Gamma \vdash \pi_i e:t_i}
  { }
  \qquad
  \Infer[Pair]
...
%            { }
        \Infer[Base]
        { }
        { \Gamma \evdashCF \tenv \Gamma }
        { }
        \qquad
        \Infer[Path]
        { (e,t)\in\tenv \\ \pvdash {\Gamma'} e t \varpi:t' \\ \Gamma \evdashCF \tenv \Gamma' }
        { \Gamma \evdashCF \tenv \Gamma',(\occ e \varpi:t') }
        { }
    \end{mathpar}
