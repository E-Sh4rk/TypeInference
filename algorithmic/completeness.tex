...
\begin{document}
  ...
  \begin{lemma}[Monotonicity] Let $\Gamma$, $\Gamma'$ and $e$ such that $\Gamma'\leqA^e \Gamma $. We have:
    \begin{align*}
      &\tyof e {\Gamma'} \leq \tyof e {\Gamma}\\
      &\forall t,\varpi.\ \tyof e \Gamma \neq \tsempty \Rightarrow \env {\Gamma',e,t} (\varpi) \leq \env {\Gamma,e,t} (\varpi)\\
      &\forall t.\ \tyof e \Gamma \neq \tsempty \Rightarrow \Refine {e,t} {\Gamma'} \leqA^e \Refine {e,t} \Gamma\\
    \end{align*}
  \end{lemma}
