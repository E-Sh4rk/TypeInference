...
\begin{document}
  ...
  As $e$ is well-typed, we have $\tsrep {\tyof {\occ e {\varpi'.1}} {\Gamma'}} \leq \tsrep {\tyof {\occ e {\varpi'.1}} {\Gamma}} \leq \dom {t_2}$.\\
  ...
  Then, using the monotonicity of the second argument of $\worra {}{}$:
  \begin{align*}
